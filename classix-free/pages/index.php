        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="logout.php"><i class="lnr lnr-enter"></i> Login</a></li>
                    ...
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select">
                        <select class="dropdown-product selectpicker" name="product-cat" >
                          ...
                          <option class="subitem" value="electronics"> Electronics</option>
            ...
            <div class="col-md-12">
              <div class="box-title no-border">
                <div class="inner">
                  ...
                  <a href="category.html" class="sell-your-item"><i class="fa fa-th-large"></i> View more 
                  </a>
                </div>
              </div>
            </div>
