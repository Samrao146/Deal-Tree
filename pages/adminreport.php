...
session_start();
$query = "SELECT * FROM `report` where `count`>10";
    ...
    <!-- Content section Start --> 
      ...
      <div class="container">
          <div class="row">
				...
				Ads
				<a class="pull-right" aria-expanded="true" data-toggle="collapse" href="#ads">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2"><i class="fa fa-credit-card"></i> Reported Ads</h2>
			  ...
			  ?>
                    <tr>
                      ...
                      <td class="ads-details-td"> 	
					  							<?php  			
									$queryforpost = "SELECT * FROM `POST` where `post_id`=?";
									$pds1 = $conn-> prepare($queryforpost);
									$pds1-> execute(array( $postid ));
									$row4 = $pds1->fetchAll();
									$num4 = $pds->rowCount();
									foreach($row4 as $value4){
						?>	
						<h4><a href=""><?php echo $value4['post_title']?></a></h4>
                        <!--<strong> Posted On </strong>:
                        Date ethe ayege agar haige a ta</p> -->
                        <p> <!--<strong>Visitors </strong>: 221 --><strong>Located In:</strong> <?php echo $value4['post_location']?> </p>
                      </td>
                      <td class="price-td">
                        <strong> $<?php echo $value4['post_pice']?></strong>
                      </td>
                      <td >
                        
						
                        <!--<p><a class="btn btn-info btn-xs"> <i class="fa fa-share-square-o"></i> Share</a></p>-->
                        <p><a href='admindelte.php?id=<?php echo $value['post_id'] ?>' class="btn btn-danger btn-xs"> <i class=" fa fa-trash"></i> Delete</a></p>
